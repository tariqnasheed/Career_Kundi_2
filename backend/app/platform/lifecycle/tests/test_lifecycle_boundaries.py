"""Lifecycle refs/kinds must stay framework/feature free."""
...
def test_lifecycle_pure_modules_forbidden_imports() -> None:
    violations: list[str] = []
        ...
        for node in ast.walk(tree):
            ...
            for mod in mods:
                ...
                for prefix in _FORBIDDEN:
                    ...
                    if prefix in {"workflow", "scheduler"} and prefix in mod.split("."):
                        violations.append(f"{path.name}: {mod}")
